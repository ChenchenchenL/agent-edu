...
CLI / TUI 交互形式参考见 [docs/hermes-cli-style-reference.md](docs/hermes-cli-style-reference.md)。
当前 CLI-first 落地说明见 [docs/CLI_TUI_DESIGN.md](docs/CLI_TUI_DESIGN.md)。
...
> Phase 1 主教学链路已打通，Phase 2 自主任务系统已完成第一轮正式收尾，CLI-first / TUI learner workspace baseline 已落地。
...
- learner-first TUI 工作台 baseline
...
- CLI-first learner workspace / TUI baseline
